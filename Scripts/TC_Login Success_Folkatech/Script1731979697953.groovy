...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Dashboard/h3_Dashboard'), 'Dashboard')

//WebUI.verifyElementText(findTestObject('Object Repository/Page_Dashboard/h3_Dashboard'), encryptedPassword)
//WebUI.verifyElementPresent(findTestObject(), index)

//WebUI.click(findTestObject('Object Repository/Page_Dashboard/h3_Dashboard'))
